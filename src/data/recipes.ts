...
export const recipes: Recipe[] = [
  ...
  // Categoría 4: Panes con Fermentación Corta (30 recetas)
  { 
    id: "64",
    title: "🍞 Pan de molde esponjoso (arroz + tapioca + psyllium) — versión optimizada", 
    ...
    ingredients: [
      ...
      "Azúcar: 10 g",
      "Sal: 5 g",
      "Agua tibia: 270 ml (antes 260 ml → mayor esponjosidad)",
      "Aceite de oliva: 30 ml",
      "Vinagre de manzana: 10 ml"
    ],
    instructions: [
      "En un bol grande, mezcla harina, tapioca, psyllium, levadura, azúcar y sal.",
      "Agrega el agua tibia, aceite y vinagre.",
      "Mezcla 2–3 minutos hasta que la masa espese y se forme un \"gel elástico\". Textura esperada: masa densa, húmeda, que cae lentamente de la espátula.",
      "Vierte en el molde, alisa la superficie con espátula mojada.",
      "Cubre y deja levar 30–40 min, hasta que llegue casi al borde (no más).",
      "Hornea 35 min a 190 °C.",
      "Desmolda y enfría sobre rejilla."
    ],
    expectedTexture: "Miga suave, esponjosa, perfecta para rebanar.",
    chefTip: "No sobrelevar: si pasa el borde, el pan colapsará. Para corteza dorada, pincela con aceite antes del horneado. Deja enfriar completamente antes de cortar para que la miga se asiente.",
    prepTime: "10 min", 
    cookTime: "35 min", 
    servings: "12 rebanadas" 
  },
  { 
    id: "65",
    title: "🥖 Pan baguette de fermentación corta (sin gluten) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      ...
      "Azúcar: 8 g",
      "Sal: 5 g",
      "Agua tibia: 290 ml (antes 280 ml → mejor alveolado)",
      "Aceite: 20 ml"
    ],
    instructions: [
      "Mezcla todos los secos en un bol.",
      "Agrega el agua tibia y el aceite.",
      "Mezcla 2–3 min hasta formar una masa espesa y pegajosa. Textura esperada: masa húmeda que sostiene la forma.",
      "Aceita tus manos (NO solo agua) y forma dos baguettes.",
      "Colócalas sobre bandeja con papel vegetal.",
      "Cubre y deja levar 30 min.",
      "Haz 3–4 cortes diagonales con cuchillo húmedo.",
      "Hornea 25–30 min a 200 °C con un vaso pequeño de agua en la base del horno para vapor."
    ],
    expectedTexture: "Corteza crujiente, interior tierno y aireado.",
    chefTip: "Aceitar las manos facilita el moldeado sin romper la masa. El vapor ayuda a lograr corteza crujiente real. Para baguette más aireada, añade 1 clara extra a la mezcla.",
    prepTime: "10 min", 
    cookTime: "25-30 min", 
  ...
  { 
    id: "66",
    title: "🌾 Pan rústico con corteza crujiente (levadura instantánea) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      ...
      "Sal: 4 g",
      "Azúcar: 8 g",
      "Agua tibia: 290 ml (antes 280 ml → mejor hidratación)",
      "Aceite de oliva: 25 ml"
    ],
    instructions: [
      "Mezcla harinas, fécula, psyllium, levadura, sal y azúcar.",
      "Agrega el agua y el aceite.",
      "Mezcla 2–3 min hasta que el psyllium forme una masa tipo gel. Textura esperada: densa, húmeda, pegajosa.",
      "Vierte en molde o forma una bola con manos ligeramente aceitadas.",
      "Cubre y deja levar 45 min.",
      "Hornea 35–40 min a 200 °C.",
      "Enfriar completamente antes de cortar para evitar que la miga se compacte."
    ],
    expectedTexture: "Corteza firme y miga compacta, ideal para sopas.",
    chefTip: "Si quieres corteza más firme: rocía agua sobre el pan antes de hornear. También puedes espolvorear harina de maíz para un toque rústico. Este pan es perfecto para sopas y guisos por su miga compacta.",
    prepTime: "10 min", 
    cookTime: "35-40 min", 
  ...
  { 
    id: "67",
    title: "🍃 Pan con aceitunas y romero (una fermentación) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 200 g",
      "Fécula de maíz: 80 g",
      ...
      "Azúcar: 5 g",
      "Sal: 4 g",
      "Agua tibia: 270 ml (antes 260 ml → más aireado)",
      "Aceite de oliva: 30 ml",
      "Aceitunas verdes bien secas y picadas: 50 g",
      "Romero fresco o seco: 2 g"
    ],
    instructions: [
      "Mezcla harinas, psyllium, levadura, azúcar y sal.",
      "Agrega agua tibia y aceite, mezcla 2–3 min hasta obtener masa espesa y uniforme.",
      "Incorpora aceitunas secas y romero.",
      "Vierte la masa en molde o bandeja, alisa con espátula mojada.",
      "Deja levar 40 min tapado.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Aromático y con sabor mediterráneo.",
    chefTip: "Las aceitunas deben estar bien secas: si llevan líquido, humedecen la masa y afectan el levado. Para más perfume, coloca unas hojas de romero encima antes de hornear. Ideal para servir tibio con aceite de oliva extra virgen.",
    prepTime: "10 min", 
    cookTime: "35 min", 
    servings: "8-10 rebanadas" 
  },
  { 
    id: "68",
    title: "🥐 Pan ciabatta sin gluten (hidratación media-alta) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 150 g",
      "Fécula de tapioca: 80 g",
      "Harina de sorgo: 70 g",
      "Psyllium: 8 g",
      "Levadura seca: 5 g",
      "Sal: 4 g",
      "Azúcar: 5 g",
    ...
    instructions: [
      "Mezcla harinas, féculas, psyllium, levadura, azúcar y sal.",
      "Agrega el agua tibia y el aceite.",
      "Mezcla 2–3 min hasta obtener una masa muy húmeda, elástica y pegajosa.",
      "Reposa 5 min para que el psyllium forme estructura.",
      "Espolvorea harina de arroz sobre una bandeja.",
      "Vuelca la masa y, con espátula, forma dos panes alargados sin amasarlos.",
      "Cubre y deja levar 40 min.",
      "Hornea 30–35 min a 200 °C.",
      "Deja enfriar 15–20 min antes de cortar."
    ],
    expectedTexture: "Miga aireada, irregular, húmeda.",
    chefTip: "La ciabatta debe quedar irregular, húmeda y aireada. Si quieres corteza más crujiente, rocía agua sobre los panes antes del horneado. No intentes amasarla: este pan se forma con espátula, no con manos.",
    prepTime: "10 min", 
    cookTime: "30-35 min", 
    servings: "2 panes medianos" 
  },
  { 
    id: "69",
    title: "🏡 Pan de campo simple (molde alargado) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Harina de maíz fina: 100 g",
      ...
      "Azúcar: 8 g",
      "Sal: 5 g",
      "Agua tibia: 290 ml (antes 280 ml → más humedad)",
      "Aceite: 25 ml"
    ],
    instructions: [
      "En un bol grande, mezcla harinas, tapioca, psyllium, levadura, azúcar y sal.",
      "Agrega el agua tibia y el aceite.",
      "Mezcla 2–3 min hasta que la masa espese y se vuelva homogénea.",
      "Reposa 5 min para activar psyllium.",
      "Vierte en molde alargado, alisa superficie con espátula mojada.",
      "Cubre y deja levar 40–50 min en lugar cálido.",
      "Hornea 35–40 min a 190 °C.",
      "Enfría sobre rejilla antes de cortar."
    ],
    expectedTexture: "Miga húmeda y uniforme, corteza rústica.",
    chefTip: "Si deseas un sabor más rústico, reemplaza 50% de harina de arroz por arroz integral. Puedes añadir semillas (chía, girasol, sésamo) arriba para darle carácter. Es un pan ideal para tostadas y sándwiches calientes.",
    prepTime: "10 min", 
    cookTime: "35-40 min", 
    servings: "10-12 rebanadas" 
  },
  { 
    id: "70", 
    title: "🍫 Pan de centeno \"fake\" (sabor y color estilo centeno, sin gluten) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      ...
      "Azúcar: 10 g",
      "Cacao sin azúcar: 5 g",
      "Café instantáneo: 1 g (opcional, intensifica aroma)",
      "Sal: 5 g",
      "Agua tibia: 290 ml (antes 280 ml → mejor textura)",
      "Aceite: 25 ml",
      "Vinagre: 10 ml"
    ],
    instructions: [
      "En un bol grande, mezcla harinas, fécula, psyllium, levadura, azúcar, cacao, café y sal.",
      "Agrega el agua tibia, aceite y vinagre.",
      "Mezcla 2–3 min hasta que la masa espese y se vuelva homogénea.",
      "Reposa 5 min para activar psyllium.",
      "Vierte en molde, alisa superficie con espátula mojada.",
      "Cubre y deja levar 40–45 min.",
      "Hornea 35–40 min a 190 °C.",
      "Enfría sobre rejilla antes de cortar."
    ],
    expectedTexture: "Miga oscura, húmeda y aromática, tipo centeno.",
    chefTip: "El cacao + café imitan el color y aroma del pan de centeno tradicional. Para un pan más intenso, agrega 1 cdta extra de cacao. Perfecto con quesos fuertes, fiambres o mantequilla.",
    prepTime: "10 min", 
    cookTime: "35-40 min", 
    servings: "10 rebanadas" 
  },
  { 
    id: "71", 
    title: "🥪 Pan de sándwich tierno (rebanado fino estilo pan lactal) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Fécula de tapioca: 100 g",
      ...
      "Azúcar: 10 g",
      "Sal: 5 g",
      "Leche vegetal tibia: 270 ml (antes 260 ml → más suavidad)",
      "Aceite: 30 ml",
      "Vinagre: 10 ml"
    ],
    instructions: [
      "Mezcla todos los secos en un bol grande.",
      "Agrega la leche tibia, el aceite y el vinagre.",
      "Bate 1–2 min hasta que la mezcla se vuelva cremosa y uniforme. Textura esperada: masa tipo merengue espeso.",
      "Vierte en un molde de pan inglés y alisa.",
      "Tapa y deja levar 35–40 min, hasta casi el borde.",
      "Hornea 35 min a 190 °C.",
      "Enfría sobre rejilla antes de cortar."
    ],
    expectedTexture: "Miga muy suave, tipo pan lactal.",
    chefTip: "Para una miga aún más suave, añade 1 clara batida junto con los líquidos. Utiliza un molde pequeño si deseas un pan más alto. Ideal para sándwiches fríos y tostadas dulces.",
    prepTime: "10 min", 
    cookTime: "35 min", 
  ...
  { 
    id: "72", 
    title: "🍔 Pan estilo bollo de hamburguesa (fermentación corta) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 200 g",
      "Fécula de tapioca: 80 g",
      ...
      "Azúcar: 10 g",
      "Sal: 4 g",
      "Agua tibia: 270 ml (antes 260 ml → masa más suave)",
      "Aceite: 30 ml",
      "Semillas de sésamo (opcional): 10 g"
    ],
    instructions: [
      "Mezcla todos los secos: harinas, féculas, psyllium, levadura, azúcar y sal.",
      "Agrega el agua tibia y el aceite.",
      "Mezcla 2–3 min hasta obtener una masa espesa y pegajosa.",
      "Reposa 5 min para activar el psyllium.",
      "Aceita tus manos y forma 6 bollos redondos.",
      "Colócalos sobre bandeja con papel vegetal.",
      "Deja levar 30–40 min, tapados.",
      "Pincela con aceite o huevo, agrega sésamo si quieres.",
      "Hornea 25–30 min a 190 °C.",
      "Enfría sobre rejilla."
    ],
    expectedTexture: "Miga suave y corteza fina.",
    chefTip: "La clave es manos aceitadas para lograr bollos lisos. Si quieres textura más elástica, añade 1 clara de huevo.",
    prepTime: "10 min", 
    cookTime: "25-30 min", 
  ...
  { 
    id: "73", 
    title: "🌭 Pan de hot dog sin gluten (molde individual) — versión optimizada",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 200 g",
      "Fécula de tapioca: 80 g",
      ...
      "Azúcar: 10 g",
      "Sal: 4 g",
      "Agua tibia: 270 ml (antes 260 ml → mejor volumen)",
      "Aceite: 25 ml"
    ],
    instructions: [
      "Mezcla todas las harinas, féculas, psyllium, levadura, azúcar y sal.",
      "Agrega agua tibia y aceite.",
      "Mezcla 2–3 min hasta que la masa se vuelva cremosa y espesa.",
      "Reposa 5 min para activar el psyllium.",
      "Vierte la mezcla en moldes individuales o forma panes alargados con manos aceitadas.",
      "Deja levar 40 min.",
      "Hornea 25–30 min a 190 °C.",
      "Enfría antes de cortar."
    ],
    expectedTexture: "Miga tierna, perfecta para hot dogs.",
    chefTip: "Para panes más elásticos, incorpora 1 clara batida antes del levado. Si quieres que brillen, pincela con aceite al sacarlos del horno. Se congelan perfectos: envolver en film y usar cuando necesites.",
    prepTime: "10 min", 
    cookTime: "25-30 min", 
    servings: "6 unidades" 
  },
  // Nuevas recetas de Fermentación Corta (20 recetas)
  {
    id: "192",
    title: "🥖 Pan blanco clásico de fermentación corta (alto y suave)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 200 g",
      "Fécula de tapioca: 90 g",
      "Fécula de maíz: 40 g",
      "Psyllium: 8 g",
      "Levadura seca: 6 g",
      "Azúcar: 10 g",
      "Sal: 5 g",
      "Agua tibia: 280–290 ml",
      "Aceite: 30 ml",
      "Vinagre: 10 ml"
    ],
    instructions: [
      "Mezcla todos los secos.",
      "Añade agua tibia, aceite y vinagre.",
      "Mezcla 2–3 min hasta gel homogéneo.",
      "Reposa 5 min.",
      "Vierte en molde, alisa.",
      "Leva 35–40 min.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Miga blanca, suave y húmeda.",
    chefTip: "Si querés más altura, usá molde pequeño.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan mediano"
  },
  {
    id: "193",
    title: "🌾 Pan integral estilo \"campo\" (arroz integral + sorgo)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz integral: 150 g",
    ...
    instructions: [
      "Mezcla harinas, fécula, psyllium, levadura, azúcar y sal.",
      "Agrega agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde y deja levar 40–45 min.",
      "Hornea 35–40 min a 190 °C."
    ],
    expectedTexture: "Pan más denso y nutritivo.",
    chefTip: "Ideal con palta o tahini.",
    prepTime: "10 min",
    cookTime: "35-40 min",
    servings: "10-12 rebanadas"
  },
  {
    id: "194",
    title: "🧀 Pan de queso suave (fermentación corta, ideal tostadas)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Fécula de tapioca: 100 g",
      ...
      "Azúcar: 10 g",
      "Sal: 5 g",
      "Queso rallado (duro o semiduro): 80 g",
      "Agua tibia: 270 ml",
      "Aceite: 30 ml"
    ],
    instructions: [
      "Mezcla secos (incluye queso rallado).",
      "Añade agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde.",
      "Leva 30–35 min.",
      "Hornea 30–35 min a 190 °C."
    ],
    expectedTexture: "El pan queda suave, ideal para tostadas saladas.",
    chefTip: "No uses quesos muy húmedos.",
    prepTime: "10 min",
    cookTime: "30-35 min",
    servings: "1 pan"
  },
  {
    id: "195",
    title: "🌻 Pan de molde con semillas (alto en fibra, fermentación corta)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      ...
      "Azúcar: 10 g",
      "Sal: 5 g",
      "Mix de semillas (chía, sésamo, girasol): 40 g",
      "Agua tibia: 290 ml",
      "Aceite: 30 ml"
    ],
    instructions: [
      "Mezcla secos y semillas.",
      "Agrega agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Miga húmeda con textura de semillas.",
    chefTip: "Si querés miga más húmeda, remojá 1 cda de chía 10 min y agrégala. Las semillas pueden ir encima también.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "12 rebanadas"
  },
  {
    id: "196",
    title: "🥨 Pan salado clásico tipo \"galleta crocante\" (delgado y crujiente)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 150 g",
      "Fécula de maíz: 80 g",
      ...
      "Sal: 5 g",
      "Azúcar: 5 g",
      "Agua tibia: 220–230 ml",
      "Aceite: 20 ml"
    ],
    instructions: [
      "Mezcla secos.",
      "Añade agua tibia y aceite.",
      "Mezcla 2 min hasta masa suave y espesa.",
      "Reposa 5 min.",
      "Extiende finamente en dos placas (con espátula mojada).",
      "Deja levar 15–20 min.",
      "Hornea 20–25 min a 200 °C hasta dorar."
    ],
    expectedTexture: "Delgado, crujiente, ideal como crackers.",
    chefTip: "Para extra crocante, pincela con aceite antes del horno. Perfecto para servir con dips o como crackers artesanales.",
    prepTime: "10 min",
    cookTime: "20-25 min",
    servings: "2 placas delgadas"
  },
  {
    id: "197",
    title: "🧄 Pan de ajo y perejil (estilo pan saborizado rápido)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Fécula de tapioca: 100 g",
    ...
    instructions: [
      ...
      "Reposa 5 min.",
      "Vierte en molde.",
      "Deja levar 35–40 min.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Aromático con sabor a ajo y perejil.",
    chefTip: "Si usás ajo fresco picado, saltealo 1 minuto antes para evitar humedad. Podés agregar queso rallado para versión gourmet.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan"
  },
  {
    id: "198",
    title: "🧅 Pan de cebolla caramelizada (gourmet, muy aromático)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Harina de sorgo: 70 g",
      ...
      "Agua tibia: 290 ml",
      "Aceite: 30 ml",
      "Cebolla caramelizada: 80 g (bien seca)"
    ],
    instructions: [
      "Mezcla secos.",
      "Añade agua, aceite y mezcla 2–3 min.",
      "Reposa 5 min.",
      "Incorpora la cebolla caramelizada seca.",
      "Vierte en molde.",
      "Leva 35–45 min.",
      "Hornea 35–40 min a 190 °C."
    ],
    expectedTexture: "Miga aromática con trozos de cebolla.",
    chefTip: "La cebolla debe estar bien seca para no afectar el levado. Aporta aroma gourmet perfecto para sándwiches.",
    prepTime: "15 min",
    cookTime: "35-40 min",
    servings: "1 pan mediano"
  },
  {
    id: "199",
    title: "🍅 Pan de tomates secos y hierbas (mediterráneo gourmet)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 170 g",
      ...
      "Agua tibia: 280 ml",
      "Aceite de oliva: 30 ml",
      "Tomates secos hidratados y secos: 50 g",
      "Orégano o mix de hierbas: 1 cdta"
    ],
    instructions: [
      "Mezcla secos.",
      "Añade agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Agrega tomates secos bien escurridos y hierbas.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Miga aromática con trozos de tomate.",
    chefTip: "Los tomates deben ir bien secos para evitar que la masa se hunda. Excelente para focaccias rápidas o tostadas aromáticas.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan"
  },
  {
    id: "200",
    title: "🌿 Pan estilo ciabatta rústica con romero (fermentación corta)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 150 g",
      "Fécula de tapioca: 80 g",
    ...
    instructions: [
      ...
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vuelca sobre bandeja enharinada y forma dos panes alargados con espátula.",
      "Espolvorea romero encima.",
      "Leva 35–40 min.",
      "Hornea 30–35 min a 200 °C."
    ],
    expectedTexture: "Miga aireada, rústica, con aroma a romero.",
    chefTip: "No intentes amasar; esta masa es semilíquida. Queda espectacular tostado con aceite de oliva.",
    prepTime: "10 min",
    cookTime: "30-35 min",
    servings: "2 panes medianos"
  },
  {
    id: "201",
    title: "🌾 Pan integral suave (sorgo + arroz integral + semillas)",
    categoryId: "panes-fermentacion",
    ingredients: [
    ...
    instructions: [
      ...
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde y deja levar 40 min.",
      "Hornea 35–40 min a 190 °C."
    ],
    expectedTexture: "Pan integral suave, no denso.",
    chefTip: "Para mayor humedad, añade 1 cda de chía hidratada.",
    prepTime: "10 min",
    cookTime: "35-40 min",
    servings: "10-12 rebanadas"
  },
  {
    id: "202",
    title: "🧀 Pan de queso y cebollín (gourmet salado)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 170 g",
      "Fécula de tapioca: 100 g",
      "Harina de maíz fina: 40 g",
      "Psyllium: 8 g",
      "Levadura: 6 g",
      "Azúcar: 10 g",
      "Sal: 5 g",
    ...
    instructions: [
      "Mezcla secos (incluyendo queso).",
      "Agrega agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Incorpora el cebollín.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Miga suave con queso y cebollín.",
    chefTip: "Combina perfecto con sopas o ensaladas.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan"
  },
  {
    id: "203",
    title: "🍄 Pan de hongos salteados y ajo (gourmet, súper aromático)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      ...
      "Agua tibia: 290 ml",
      "Aceite: 30 ml",
      "Hongos salteados bien secos: 80 g",
      "Ajo picado suave: 1 cdta"
    ],
    instructions: [
      "Saltea los hongos con el ajo y deja enfriar completamente.",
      "Mezcla secos.",
      "Agrega agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Incorpora los hongos bien secos.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35–40 min a 190 °C."
    ],
    expectedTexture: "Miga aromática con trozos de hongos.",
    chefTip: "Los hongos deben estar secos para no afectar el levado. Pan perfecto para servir tibio con sopa o pasta.",
    prepTime: "15 min",
    cookTime: "35-40 min",
    servings: "1 pan mediano"
  },
  {
    id: "204",
    title: "🫒 Pan mediterráneo de aceitunas negras y tomates asados (gourmet)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 170 g",
      ...
      "Agua tibia: 290 ml",
      "Aceite de oliva: 30 ml",
      "Aceitunas negras picadas y bien secas: 50 g",
      "Tomates cherry asados (pelados y secos): 60 g",
      "Orégano: 1 cdta"
    ],
    instructions: [
      "Mezcla harinas, fécula, psyllium, levadura, azúcar, sal y orégano.",
      "Añade agua tibia y aceite, mezcla 2–3 min.",
      "Reposa 5 min.",
      "Incorpora aceitunas y tomates secos.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35–40 min a 190 °C."
    ],
    expectedTexture: "Miga mediterránea con aceitunas y tomates.",
    chefTip: "Los tomates deben estar sin líquido para no hundir la masa. Ideal para tostadas gourmet o sándwiches mediterráneos.",
    prepTime: "10 min",
    cookTime: "35-40 min",
    servings: "1 pan mediano"
  },
  {
    id: "205",
    title: "🧀 Pan de queso, ajo y pimentón (gourmet español)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Fécula de tapioca: 90 g",
      ...
      "Agua tibia: 280 ml",
      "Aceite: 25 ml",
      "Queso semiduro rallado: 70 g",
      "Ajo en polvo: 1 cdta",
      "Pimentón dulce: ½ cdta"
    ],
    instructions: [
      "Mezcla secos (incluye queso, ajo y pimentón).",
      "Añade agua y aceite.",
      "Mezcla 2–3 min y reposa 5 min.",
      "Vierte en molde y deja levar 30–35 min.",
      "Hornea 35 min a 190 °C."
    ],
    expectedTexture: "Color suave y aroma espectacular.",
    chefTip: "Queda con un color suave y aroma espectacular. Ideal para acompañar tapas o ensaladas.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan"
  },
  {
    id: "206",
    title: "🌾 Pan energético de quinoa y semillas (alto en fibra)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 150 g",
      "Harina de quinoa: 80 g",
      "Fécula de tapioca: 70 g",
      "Psyllium: 8 g",
      "Levadura: 6 g",
      "Azúcar: 10 g",
    ...
    expectedTexture: "Pan muy nutritivo, ideal para desayunos.",
    chefTip: "La quinoa aporta sabor suave y mayor saciedad.",
    prepTime: "10 min",
    cookTime: "35-40 min",
    servings: "12 rebanadas"
  },
  {
    id: "207",
    title: "🌟 Pan de cúrcuma y semillas",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Fécula de tapioca: 80 g",
      ...
      "Agua tibia: 290 ml",
      "Aceite: 25 ml",
      "Semillas (sésamo, chía, girasol): 30 g"
    ],
    instructions: [
      "Mezcla secos y semillas.",
      "Agrega agua y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde y deja levar 40 min.",
      "Hornea 35–40 min a 190 °C."
    ],
    expectedTexture: "Color vibrante y sabor especiado suave.",
    chefTip: "La cúrcuma da color vibrante y sabor especiado suave. Ideal para acompañar hummus, vegetales y platos orientales.",
    prepTime: "10 min",
    cookTime: "35-40 min",
    servings: "1 pan"
  },
  {
    id: "208",
    title: "🥒 Pan de pepinillos y eneldo (estilo deli americano)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 170 g",
      "Fécula de tapioca: 90 g",
      "Harina de sorgo: 40 g",
      "Psyllium: 8 g",
      "Levadura seca: 6 g",
      "Azúcar: 8 g",
      "Sal: 5 g",
      "Agua tibia: 280 ml",
      "Aceite: 25 ml",
      "Pepinillos picados muy bien escurridos: 60 g",
      "Eneldo seco: 1 cdta"
    ],
    instructions: [
      "Mezcla harinas, fécula, psyllium, levadura, azúcar y sal.",
      "Agrega agua tibia y aceite; mezcla 2–3 min.",
      "Reposa 5 min.",
      "Incorpora pepinillos secos y eneldo.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35 min a 190 °C.",
      "Enfría completamente antes de cortar."
    ],
    expectedTexture: "Sabor deli clásico con pepinillos.",
    chefTip: "Los pepinillos aportan un sabor deli clásico. Deben ir sin líquido para no hundir la masa. Perfecto para sándwiches estilo \"pastrami\".",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan mediano"
  },
  {
    id: "209",
    title: "🌾 Pan alto de teff y chía (nutritivo, estilo artesanal)",
    categoryId: "panes-fermentacion",
    ingredients: [
    ...
    instructions: [
      "Mezcla todos los secos incluyendo la chía.",
      "Agrega agua tibia y aceite; mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde y deja levar 40–45 min.",
      "Hornea 35–40 min a 190 °C.",
    ...
    expectedTexture: "Pan con sabor profundo, alto en minerales.",
    chefTip: "La chía actúa como espesante natural y aporta humedad. Ideal para desayunos y tostadas saludables.",
    prepTime: "10 min",
    cookTime: "35-40 min",
    servings: "1 pan alto"
  },
  {
    id: "210",
    title: "🌿 Pan de hierbas provenzales y aceite de oliva (gourmet francés)",
    categoryId: "panes-fermentacion",
    ingredients: [
      "Harina de arroz: 180 g",
      "Fécula de tapioca: 90 g",
    ...
    expectedTexture: "Aromático con hierbas provenzales.",
    chefTip: "Acompaña perfecto quesos, ensaladas y sopas. Para aroma extra, pincela con aceite y hierbas antes de hornear.",
    prepTime: "10 min",
    cookTime: "35 min",
    servings: "1 pan"
  },
  {
    id: "211",
    title: "🎃 Pan de calabaza asada y tomillo (color y aroma espectaculares)",
    categoryId: "panes-fermentacion",
    ingredients: [
      ...
      "Azúcar: 10 g",
      "Sal: 5 g",
      "Puré de calabaza asada (bien seco): 120 g",
      "Agua tibia: 260–270 ml",
      "Aceite: 25 ml",
      "Tomillo: 1 cdta"
    ],
    instructions: [
      "Mezcla harinas, fécula, psyllium, levadura, azúcar, tomillo y sal.",
      "Añade puré de calabaza, agua tibia y aceite.",
      "Mezcla 2–3 min.",
      "Reposa 5 min.",
      "Vierte en molde y deja levar 35–40 min.",
      "Hornea 35–40 min a 190 °C.",
      "Deja enfriar para que tome estructura."
    ],
    expectedTexture: "Color dorado intenso y sabor suave especiado.",
    chefTip: "La calabaza debe estar bien seca, no acuosa. Da color dorado intenso y sabor suave especiado. Perfecto para untar con queso crema o sopas.",
    prepTime: "15 min",
    cookTime: "35-40 min",
    servings: "12 rebanadas"
  },
